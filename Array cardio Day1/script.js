...
// 1. Filter the list of inventors who were born in 1500's
...
// 2. Give an array of the inventory first and last name
...
const oldest = inventors.sort(function (a, b) {
    ...
    const inventorSecond = b.passed - b.year;
    return inventorOne < inventorSecond ? -1 : 1;
})
console.table(oldest);


//6. Sort the people by last name
